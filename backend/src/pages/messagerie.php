	...
	<div class="container accueil">
		<div class='row'>
			<div class="panel panel-default text-center">
			  ...
			  <div class="panel-heading"><strong>les messages </strong></div>
			  ...
			  <table class="table">
			    ...
			    <tr>
			    	...
			    	<td>11/02/2017</td>
			    	<td>en cours...</td>
			    	<td><a href=""><input type="submit" value='suprimé' class="btn btn-success"></a></td>
			    	<td><a href=""><input type="submit" value='repondre' class="btn btn-warning"></a></td>
			    	<td><a href=""><input type="submit" value='transférer' class="btn btn-warning"></a></td>
			    </tr>
			  </table>
			</div>
