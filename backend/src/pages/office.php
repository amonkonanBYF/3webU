...
<body >
	...
	<div class="container abonnez-vous">
		<div class="row">
			...
			<div class="col-xs-6">
				<h2>Liste des cours par faculté</h2>

				<div class="list-group">
				  <button type="button" class="list-group-item"><span class="badge">4</span>Litérzture et civilisation</button>
				  <button type="button" class="list-group-item"><span class="badge">14</span>sciences humaine</button>
				  <button type="button" class="list-group-item"><span class="badge">10</span>math&info</button>
				  <button type="button" class="list-group-item"><span class="badge">16</span>Science de la terre...</button>
				  <button type="button" class="list-group-item"><span class="badge">24</span>economie et gestion</button>
				</div>
			</div>
		</div>
		<div class="row"></div>
